...
class DependencyProvider
{
    public function providerDependency(Container $container): void
    {
        ...
        $container->set(QueryBuilder::class, new QueryBuilder($container->get(SQLConnector::class)));

        $container->set(ProductRepository::class, new ProductRepository($container->get(SQLConnector::class)));
        $container->set(ProductManager::class, new ProductManager($container->get(SQLConnector::class)));

        $container->set(UserRepository::class, new UserRepository($container->get(SQLConnector::class)));
        $container->set(UserManager::class, new UserManager($container->get(SQLConnector::class)));

...
abstract class Category implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Generated\\Map\\CategoryTableMap';
    ...
    /**
     * Initializes internal state of Generated\Base\Category object.
     */
     ...
     * @return $this|\Generated\Category The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Generated\\Category'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Generated\Category
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Generated\Category The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Generated\Category (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Generated\Category Clone of current object.
     * @throws PropelException
     */
    ...
    public function initProducts($overrideExisting = true)
    {
        ...
        $this->collProducts->setModel('\Generated\Product');
    }
        ...
        if (null === $this->collProducts || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collProducts) {
                    ...
                    $collProducts->setModel('\Generated\Product');

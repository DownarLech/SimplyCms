...
abstract class Product implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Generated\\Map\\ProductTableMap';
    ...
    /**
     * Initializes internal state of Generated\Base\Product object.
     */
     ...
     * @return $this|\Generated\Product The current object (for fluent API support)
     */
    ...
    public function setProductname($v)
    {
        ...
        if ($this->productname !== $v) {
            $this->productname = $v;
            $this->modifiedColumns[ProductTableMap::COL_PRODUCTNAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Generated\\Product'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_PRODUCTNAME)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Generated\Product The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_PRODUCTNAME)) {
            $criteria->add(ProductTableMap::COL_PRODUCTNAME, $this->productname);
        }
        if ($this->isColumnModified(ProductTableMap::COL_DESCRIPTION)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Generated\Product (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Generated\Product Clone of current object.
     * @throws PropelException
     */

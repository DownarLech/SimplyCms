...
use \Exception;
use \PDO;
use Generated\Category as ChildCategory;
use Generated\CategoryQuery as ChildCategoryQuery;
use Generated\Map\CategoryTableMap;
 ...
 *
 * @method     \Generated\ProductQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Generated\Base\CategoryQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'SimplyCmsPropel', $modelName = '\\Generated\\Category', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Generated\Product object
     *
     * @param \Generated\Product|ObjectCollection $product the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($product instanceof \Generated\Product) {
            return $this
            ...
            throw new PropelException('filterByProduct() only accepts arguments of type \Generated\Product or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Generated\ProductQuery A secondary query class using the current class as primary query
     */
    public function useProductQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinProduct($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Product', '\Generated\ProductQuery');
    }

    /**
     * Use the Product relation Product object
     *
     * @param callable(\Generated\ProductQuery):\Generated\ProductQuery $callable A function working on the related query
     *
     ...
     *
     * @return \Generated\ProductQuery The inner query object of the EXISTS statement
     */
     ...
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Generated\ProductQuery The inner query object of the NOT EXISTS statement
     */

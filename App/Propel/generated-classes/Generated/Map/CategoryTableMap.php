...
class CategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Generated.Map.CategoryTableMap';
     ...
     */
    const OM_CLASS = '\\Generated\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Generated.Category';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Generated\\Category');
    ...
    {
        $this->addRelation('Product', '\\Generated\\Product', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':category_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Generated\Category) { // it's a model object
